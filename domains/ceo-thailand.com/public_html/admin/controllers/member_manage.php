                        ...
                        <div class="da-form-inline">
                            ...
                            <div class="da-form-row">
                                ...
                                <div class="span6">
                                    ...
                                    <div class="da-form-item large">
                                        <input type="text" readonly="" value="<?php echo ($member->GetPrimary() != '') ? $member->GetValue('member_group_id') : ''; ?>" class="span12" />
                                    </div><br>
                            ...
                            <div class="da-form-row">
                                ...
                                <label class="da-form-label"> คลิ้กโฆษณา </label>
                                <div class="da-form-item large">

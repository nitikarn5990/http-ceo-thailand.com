...
if ($_POST['submit_bt'] == 'บันทึกข้อมูล' || $_POST['submit_bt'] == 'บันทึกข้อมูล และแก้ไขต่อ') {
    ...
    if ($location->Save()) {
        SetAlert('เพิ่ม แก้ไข ข้อมูลสำเร็จ', 'success');
            ...
            header('location:' . ADDRESS_ADMIN_CONTROL . 'about&action=edit&id=' . $location->GetPrimary());
            die();
    ...
    ?>
            <div class="da-panel collapsible">
                ...
                <div class="da-panel-content da-form-container">
                    <form id="validate" enctype="multipart/form-data" action="<?php echo ADDRESS_ADMIN_CONTROL ?>about<?php echo ($location->GetPrimary() != '') ? '&action=edit&id=' . $location->GetPrimary() : ''; ?>" method="post" class="da-form">
